...
main() {
    ...
    KEY_NAME="shell-script"
    SUBNET_ID="subnet-06f3edece7d8a5245"
    SECURITY_GROUP_IDS="sg-09c1d14cdb2bcac9f"  # Add your security group IDs separated by space
    INSTANCE_NAME="shell-scripting"
